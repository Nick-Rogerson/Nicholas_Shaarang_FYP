...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/nrogerson/Documents/Nicholas_Shaarang_FYP/jackal_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/nrogerson/Documents/Nicholas_Shaarang_FYP/jackal_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/nrogerson/Documents/Nicholas_Shaarang_FYP/jackal_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dngu0016 <dngu0016@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nrogerson/Documents/Nicholas_Shaarang_FYP/jackal_ws/src/image_processing/${idir}'.  ${_report}")
    endif()
